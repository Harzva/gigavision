...
def full():
    ...
    [26583,14957],
    [26573,15052]]
    UP_boundary=[3552,2004,0,0,5990,4257,3813]
    #是否use keep_dets()
    iskeep_dets=0
    ...
    cls_="elema"#head 
    dataset="selfbicyle"
    resfile="/root/data/gvision/mmdetection-master/workdir/detectors_vehicle_method2_elema/output/test_bbox.json"
    ...
    imgfilters=["15_27","14_02","16_01","17_23","18_01","18_40","18_41"]
    ...
    merge_result_visual(image_folder_test="/root/data/gvision/dataset/raw_data/image_test",
                ...
                test=test,
                mode="xywh",
                num=10,score=0.3)#mode: input_bbox mode
def main():
    full()
