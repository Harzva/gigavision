...
class DetResMerge():
    def __init__(self,
        ...
        :param resmode: detection result mode, which can be 'person', 'head', 'headbbox' or 'headpoint'
...
def head():
    ...
    isdel_inter=0#
    test=1
    fliterscore={"14_OCT":0.1,"15_nanshan":0.1,"1601_shool":0.1,"1602_shool":0.1,"17_newzhongguan":0.1,"1801_xilin":0.1,"1802_xilin":0.1}
    nms_name="softnms"
    nms_thresh=0.7
    network="retinaface"
    weights="final_model"
    cls_="head"#head 
    dataset="person_unsure"
    resfile="/root/data/gvision/detectron2-master/workdir/output/my_head_retinaface_ms_panda/my_predict/final_nms0.7_fs0.1_all.json"
