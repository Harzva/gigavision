...
class DetResMerge():
    def __init__(self,
        ...
        :param resmode: detection result mode, which can be 'person', 'visible', 'headbbox' or 'headpoint'
        ...
        def say2(iss):
            ...
            if isfliter:
                ...
                if 421<=imageid<=450:#15 nanshangongyuan
                    ...
                    segma_woh=3,segma_area=2,up_bound=1500,down_bound=7000,down_fs=None,yichang=1)
...
def visible():
    ...
    cls_="visible"#head 
    dataset="big"
    resfile="/root/data/gvision/CrowdDet-master/model/rcnn_emd_refinet/visiblebody/outputs/eval_dump/binms0.35prethre0.4.json"
    # resfile="/root/data/gvision/CrowdDet-master/model/rcnn_emd_refinet/visiblebody/outputs/eval_dump/vbnms0.35prethre0.4.json"
    # resfile="/root/data/gvision/mmdetection-master/workdir/detectors_visible_method2/output/coco_bicycle_and_panda_else/split_reuslt_detectros_else_big_bbox.json"
    # resfile="/root/data/gvision/mmdetection-master/workdir/detectors_visible_method2/output/epoch_12_car/split_reuslt_detectros_car_big_bbox.json"
    # resfile="/root/data/gvision/mmdetection-master/workdir/detectors_visible_method2/output/epoch_12_car/split_reuslt_detectros_car_17_bbox.json"
    # resfile="/root/data/gvision/mmdetection-master/workdir/detectors_visible_method2/output/epoch_12_car/split_reuslt_detectros_car_without17_bbox.json"
    ...
    # splitannofile="/root/data/rubzz/ruby/ruby_output/test/visible/test_bbox_visible_1333_1238_17_noresize.json"
    # splitannofile="/root/data/rubzz/ruby/ruby_output/test/visible/test_bbox_visible_1333_1238_without17.json"
    ...
    merge.mergeResults(outfile=outfile,is_nms=False,nms_thresh=nms_thresh,nms_name=nms_name)
