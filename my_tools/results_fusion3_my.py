...
def model_fusion( outpath="/root/data/gvision/my_merge/fusion_results",
    outfile="fafaxue_final_wnms_all.json",model_num=7):
    results_all=[[],[],[],[]]
    a=["14","15","16","17","18"]
    b=["15","16","17"]
    no=["no"]
    ...
    for idj,i in enumerate(zip(
                ...
                selected1=a,selected2=a,selected3=a,selected4=a)),

                list(results_resolve(model_path=json_root+"12/coco_results/detectors_reusme_fafaxue/detectors_reusme_delinter0isfliter112datasetfafaxuesetnms0.6.json",weight=[0.8,0.8,0.8,0.8],
                selected1=a,selected2=a,selected3=a,selected4=a)),
                ...
                list(results_resolve(model_path=json_root+"head/coco_results/detectors_reusme_fafaxue/detectors_reusme_delinter0isfliter1headdatasetfafaxuenms0.6.json",weight=[0.8,0.8,0.8,0.8],
                selected1=a,selected2=a,selected3=a,selected4=a)),
    ...
    # afternms_results3=wnms(results3,outpath,outfile=outfile,iouthresh=1,savejson=0,nmsname="softnms")#"nms")#
...
def main():
    ...
    model_fusion(outpath=outpath,
            outfile="final_softnms_all.json")#must all
