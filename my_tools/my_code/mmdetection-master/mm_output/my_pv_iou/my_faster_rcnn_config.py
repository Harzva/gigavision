...
train_pipeline = [
    ...
    dict(
        type='Resize',
        img_scale=[(1024, 256), (1024, 512), (1024, 768), (1024, 1024),
                   (1024, 2048)],
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/root/data/gvision/dataset/train_all_annos/s0.3_t0.7_all/image_annos/coco_pv_train_bbox_hwnoi.json',
        img_prefix=
    ...
    val=dict(
        type='CocoDataset',
        ann_file=
        '/root/data/gvision/dataset/inference/VAL_split/image_annos/coco_pv_VAL_hwnoi.json',
    ...
    test=dict(
        type='CocoDataset',
        ann_file=
        '/root/data/gvision/dataset/predict/s0.5_t0.9_14/image_annos/coco_results_hw.json',
