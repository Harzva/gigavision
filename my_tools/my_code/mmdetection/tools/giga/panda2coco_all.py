...
def main():
    person_path = '/root/panda/annotations/person_train.json'
    vehicle_path = '/root/panda/annotations/vehicle_train.json'
    with open(person_path, "r") as fp:
        person_json_data = json.load(fp)
    with open(vehicle_path, "r") as fp:
        vehicle_json_data = json.load(fp)
    cvt_annotations(person_json_data, vehicle_json_data, '/root/panda/annotations/all_train.json')
    print('Done!')
